...
class BaseConfiguration(object):
    ...
    """
    The time at which the simulation takes a final sample and terminates.
    """
    ...
    def to_latex_table(self, experiment, **kwargs):
        ...
        t.append('\\label{tab:ctmixtures-sim-parameters}\n')
        t.append('\\end{table}\n')
...
class MixtureConfiguration(BaseConfiguration):
    ...
    """
    Innovation rate is given in THETA values, which are translated into appropriate mutation probabilities by
    code, taking into account the population size.
    """
